...
def db_conn():
    ...
    cursor.executescript("""
        ...
        CREATE INDEX IF NOT EXISTS idx_paper_orders_fingerprint ON paper_orders(fingerprint);
        CREATE INDEX IF NOT EXISTS idx_paper_orders_status ON paper_orders(status);
        CREATE INDEX IF NOT EXISTS idx_paper_orders_rec ON paper_orders(recommendation_id);
        ...
        CREATE INDEX IF NOT EXISTS idx_paper_positions_fingerprint ON paper_positions(fingerprint);
        CREATE INDEX IF NOT EXISTS idx_paper_positions_status ON paper_positions(status);
        CREATE INDEX IF NOT EXISTS idx_paper_positions_rec ON paper_positions(recommendation_id);
        CREATE INDEX IF NOT EXISTS idx_paper_positions_event ON paper_positions(event_id);
        CREATE INDEX IF NOT EXISTS idx_paper_positions_provider ON paper_positions(provider);
